...
SETUPDATA = dict(
    ...
    description=("Nexus BlissData Writer"),
    license="GNU GENERAL PUBLIC LICENSE v3",
    keywords="configuration blissdata writer Tango server nexus data",
    url="http://github.com/jkotan/nexdatas/nxsblisswriter",
    packages=[NXS],
    classifiers=[
    ...
    entry_points={
        'console_scripts':
        'NXSBlissWriter = nxsblisswriter:main'},
    # scripts=['NXSBlissWriter'],
    cmdclass={
        # 'test': TestCommand,
